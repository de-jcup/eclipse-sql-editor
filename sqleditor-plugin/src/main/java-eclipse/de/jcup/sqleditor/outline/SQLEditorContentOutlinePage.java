...
public class SQLEditorContentOutlinePage extends ContentOutlinePage implements IDoubleClickListener {
	...
	private static ImageDescriptor IMG_DESC_NOT_LINKED = EclipseUtil
			.createImageDescriptor("/icons/outline/sync_broken.png", SQLEditorActivator.PLUGIN_ID);

	private SQLEditorTreeContentProvider contentProvider;
	private Object input;
	private SQLEditor editor;
	private SQLEditorOutlineLabelProvider labelProvider;
	...
	public SQLEditorContentOutlinePage(SQLEditor editor) {
		this.editor = editor;
		this.contentProvider = new SQLEditorTreeContentProvider();
	}

	public SQLEditorTreeContentProvider getContentProvider() {
	...
	public void createControl(Composite parent) {
		...
		labelProvider = new SQLEditorOutlineLabelProvider();
	...
	public void onEditorCaretMoved(int caretOffset) {
		...
		if (contentProvider instanceof SQLEditorTreeContentProvider) {
			SQLEditorTreeContentProvider gcp = (SQLEditorTreeContentProvider) contentProvider;
	...
	public void rebuild(SQLScriptModel model) {
		if (model == null) {
			return;
		}
