...
public interface SQLEditorColorConstants {
	...
	public static final RGB MIDDLE_GREEN_2 = rgb(77,154,6); // a little bit lighter
    ...
    public static final RGB MIDDLE_CYAN = rgb(0,128,128);
