	...
	private class SimpleWordProposal implements ICompletionProposal, ICompletionProposalExtension7 {
		...
		public void apply(IDocument document) {
			...
			try {
				...
				SQLEditorUtil.logError("Not able to replace by proposal:" + word +", zero offset:"+zeroOffset+", textBefore:"+textBefore, e);
			}
		...
		public StyledString getStyledDisplayString(IDocument document, int offset,
			...
			try {
				...
				SQLEditorUtil.logError("Not able to set styles for proposal:" + word, e);
			}
			return styledString;
		}
