...
import de.jcup.sqleditor.outline.FallbackOutlineContentProvider;
...
public abstract class AbstractFilterableTreeQuickDialog<T> extends AbstractQuickDialog implements IDoubleClickListener {
	...
	private class FilterKeyListener extends KeyAdapter {
		...
		public void keyReleased(KeyEvent e) {
			...
			UIJob job = new UIJob("Rebuild sql editor quick outline") {
				...
				public IStatus runInUIThread(IProgressMonitor monitor) {
					try {
						...
						EclipseUtil.logError("quick dialog failure", e, SQLEditorActivator.getDefault());
					}
					dirty = false;
