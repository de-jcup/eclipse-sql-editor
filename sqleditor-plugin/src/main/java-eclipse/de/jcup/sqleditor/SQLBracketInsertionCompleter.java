...
class SQLBracketInsertionCompleter extends KeyAdapter {
	 ...
	 * @param sqlEditor
	 */
	SQLBracketInsertionCompleter(SQLEditor sqlEditor) {
	...
	public void keyReleased(KeyEvent e) {
		 ...
		 * different
		 */
		ISelectionProvider selectionProvider = this.sqlEditor.getSelectionProvider();
