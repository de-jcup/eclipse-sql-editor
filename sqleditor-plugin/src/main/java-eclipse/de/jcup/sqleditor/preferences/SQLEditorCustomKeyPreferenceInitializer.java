...
public class SQLEditorCustomKeyPreferenceInitializer extends AbstractPreferenceInitializer {
    ...
    public void initializeDefaultPreferences() {
        SQLEditorCustomKeyDefinitionConverter converter = new SQLEditorCustomKeyDefinitionConverter();

        List<SqlEditorCustomKeyDefinition> list = SQLEditorCustomKeyDefaults.get();
