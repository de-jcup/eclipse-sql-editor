...
public class SQLEditorPreferences {
    ...
    public int getStyle(SQLEditorSyntaxStylePreferenceConstants style) {
        String styleDataContentId = getPreferenceStore().getString(style.getId());
        SQLEditorSyntaxStyle foundStyle = SQLEditorSyntaxStyle.fromId(styleDataContentId);
        if (foundStyle == null) {
            return SWT.NONE;
        }
        return foundStyle.getSWTStyle();
    }
    ...
    public void setDefaultStyle(SQLEditorSyntaxStylePreferenceConstants styleConstant, SQLEditorSyntaxStyle style) {
        getPreferenceStore().setDefault(styleConstant.getId(), style.getId());
    }
